...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Bienvenido a Nexus API REST en CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
...
<section>
    ...
    <p>URL: http://localhost/nombre-del-proyecto/public/user/1</p>
